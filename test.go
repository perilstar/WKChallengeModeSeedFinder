...
var itemData = map[string]float64{
	"speed":        1.0,
	"fireRate":     2.8,
	"multiShot":    3.3,
	"wallPunch":    1.25,
...
func main() {
	...
	*/
	...
	fmt.Println("color:", float32(r)/255, float32(g)/255, float32(b)/255, 1.0)
}
...
// this one is in the source code from godot, and might be used for the global random number generator
